...
#calculate the err through variance
def regErr(dataSet):
    return var(dataSet[:,-1])*shape(dataSet)[0]

def chooseBestSplit(dataSet,leafType,errType,ops):
    #tolS is a tolerance on the error reduction and tolN is the minimum data instances to include in a split
...
# for model tree. it's leaves are linear functions
